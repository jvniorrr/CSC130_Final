...
public class Main{
	...
	public static stopWatchX timer = new stopWatchX(250); // set flashing timer to 250 or 1/4 of second
	// object to set coordinates of sprites
	public static Vector2D bottomRightVec1 = new Vector2D(1105, 575); // bottom right corner coords.
	...
	public static void update(Control ctrl) {
		...
		if (timer.isTimeUp()) {
				...
				if (vecs1.isEmpty()) {
					...
					// System.out.println(Arrays.toString(vecs2.toArray()));
				}
